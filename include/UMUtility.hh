...
namespace UMass { 
   namespace Utility{
	 ...
	 kFixedProbe    = 3
      ...
      double GetT2Time_v3a(int startIndex,NMRPulse *aPulse,int verbosity=0);
      ...
      // phase fit functions 
      int poly1(const gsl_vector * x, void *data,gsl_vector * f);
      ...
      int poly9(const gsl_vector * x, void *data,gsl_vector * f);
